...
namespace Ophim\ThemeIq\Controllers;
...
class ThemeIqController
{
    ...
    public function index(Request $request)
    {
        if ($request['search'] || $request['filter']) {
            ...
            return view('themes::themeiq.catalog', [
                'data' => $data,
                'search' => $request['search'],
                'section_name' => "Tìm kiếm phim: $request->search"
            ]);
        }
        return view('themes::themeiq.index', [
    ...
    public function getMovieOverview(Request $request)
    {
        ...
        return view('themes::themeiq.single', [
            'currentMovie' => $movie,
    ...
    public function getEpisode(Request $request)
    {
        ...
        return view('themes::themeiq.episode', [
            'currentMovie' => $movie,
            'movie_related' => $movie_related,
            'episode' => $episode,
