...
<script src="/themes/iq/rating2/jquery.raty.js"></script>
<script>
    var rated = false;
    $('#star').raty({
        number: 10,
        starHalf: '/themes/iq/rating2/images/star-half.png',
        starOff: '/themes/iq/rating2/images/star-off.png',
        starOn: '/themes/iq/rating2/images/star-on.png',
