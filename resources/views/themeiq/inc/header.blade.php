        ...
        <div class="myui_custom_header">
                            ...
                            <li class="search-box dropdown-hover" href="javascript:;">
                                <form id="search" name="search" method="get" action="/">
                                    ...
                                    <button class="submit search_submit icon-btn" id="searchbutton" type="submit" name="submit">
                                        <svg><use xlink:href="/themes/iq/static/sprite.svg#icon-search"></use></svg>
                                    </button>
                                </form>
            ...
            {{-- <div id="box-user-menu" class="actions-user right">
                <div><a onclick="alert('Chức năng này đang cập nhật');return false;"><svg
                            ...
                            <use xlink:href="/themes/iq/static/users.svg#sign-in"></use>
                        </svg>
                        Đăng nhập</a></div>
                <div><a onclick="alert('Chức năng này đang cập nhật');return false;"><svg
                            class="icon icon--white icon-users">
                            <use xlink:href="/themes/iq/static/users.svg#users"></use>
                        </svg>
                        Đăng ký</a></div>
                <div><a onclick="alert('Chức năng này đang cập nhật');return false;"><svg
                            class="icon icon--white icon-bookmark">
                            <use xlink:href="/themes/iq/static/users.svg#bookmark"></use>
                        </svg>
                        Bookmark</a></div>
            </div> --}}
        </div>
        <div class="mobile-control">
            <div class="menu control icon-btn" data-type="toggle" data-target=".nav"><svg><use xlink:href="/themes/iq/static/sprite.svg#icon-menu"></use></svg></div>
            <div class="search control icon-btn" data-type="toggle" data-target="#search">
                <svg><use xlink:href="/themes/iq/static/sprite.svg#icon-search2"></use></svg>
            </div>
        </div>
    </div>
